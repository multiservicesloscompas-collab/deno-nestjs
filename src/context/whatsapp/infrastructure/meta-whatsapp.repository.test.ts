...
Deno.test("MetaWhatsAppRepository.send throws specific error for Meta code 190", async () => {
  // Mock fetch
...
Deno.test("MetaWhatsAppRepository.send throws generic error for other Meta errors", async () => {
  // Mock fetch
  const originalFetch = globalThis.fetch;
  globalThis.fetch = () =>
    Promise.resolve({
